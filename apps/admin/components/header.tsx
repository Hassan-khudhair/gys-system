...
export function Header({ title, subtitle, gymName, adminName, email, onMenuClick }: HeaderProps) {
  ...
  /* Scroll-based header appearance — watches the main scroll container */
  useEffect(() => {
  ...
  return (
    ...
    >
      {/* Left — mobile menu + optional title */}
      ...
      <div className="flex items-center gap-1">
        ...
        <div className="relative ms-1" ref={dialogRef}>
          ...
          >
            ...
            <span className="hidden sm:inline text-[13px] text-muted font-medium">{adminName ?? t("gym_admin_role")}</span>
          </button>
