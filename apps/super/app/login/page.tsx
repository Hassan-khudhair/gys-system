    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0F172A] px-4">
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-[#94A3B8] text-sm mt-1">Super Admin Panel</p>
        </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div>
              ...
              <input
                ...
                required
                placeholder="admin@mastergym.com"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#8B5CF6] hover:bg-[#7C3AED] disabled:opacity-60 disabled:cursor-not-allowed text-white font-semibold rounded-lg py-2.5 text-sm transition-colors flex items-center justify-center gap-2"
            >
